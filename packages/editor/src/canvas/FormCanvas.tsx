...
export const FormCanvas = () => {
  ...
  const getCanvasStyles = () => {
    switch (screenSize) {
      case 'mobile':
        return 'canvas-sm screen-mobile'; // 384px max width, centered with mobile simulation
      case 'tablet':
        return 'canvas-md screen-tablet'; // 672px max width, centered with tablet simulation
      case 'desktop':
      default:
